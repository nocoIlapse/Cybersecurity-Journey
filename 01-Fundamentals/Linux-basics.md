...
*`pwd` - print currently directory.
*`ls` - view the list of files in the current folder.
*`ls -la` - show all files(inlucing hidden) with detalied information.
*`cd [file_name]` - go to the desired folder.
